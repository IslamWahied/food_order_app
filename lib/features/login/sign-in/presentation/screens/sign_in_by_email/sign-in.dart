...
import 'package:food_order_app/core/utils/app_constance.dart';
import 'package:food_order_app/features/home/presentation/screens/homepage.dart';
              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      SignInTitleWidget(ffem:ffem ,fem:fem,projectName: AppConstance.projectName, ) ,
                      SignInLoginWidget(
                        ffem:ffem,
                        fem: fem,
                        formKey: formKey,
                      ...
                      CreateAccountWidget(fem: fem,ffem:ffem ,)
                    ],
                  ),
                ),
              ),
...
class SignInTitleWidget extends StatelessWidget {
  ...
  const SignInTitleWidget({super.key,required this.fem,required this.ffem, required this.projectName});
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                      'Welcome to $projectName Services',
                      style: Theme.of(context)
                          .textTheme
                          .headline1
                          ?.copyWith(
...
class SignInLoginWidget extends StatelessWidget {
  ...
  const SignInLoginWidget({super.key, required this.fem,
    required this.ffem, required this.userNameControl,
...
class CreateAccountWidget extends StatelessWidget {
  final  double  fem;
  final  double  ffem;
  const CreateAccountWidget({super.key, required this.fem, required this.ffem});
