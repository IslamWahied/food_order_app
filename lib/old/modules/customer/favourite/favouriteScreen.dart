...
class FavouriteScreen extends StatelessWidget {
  const FavouriteScreen({required Key key}) : super(key: key);
    ...
    return BlocConsumer<HomeCubit, HomeState>(
        ...
        builder: (context, state) {
          ...
          return BackdropScaffold(
                    ...
                    ? Row(
                        children: [
                          GestureDetector(
                            onTap: () {
                              cubit.isShowBackLayer = false;
                              NavigatToAndReplace(context, const HomeLayout(key:   Key("24"),));
            ...
            backLayer: UserBackLayerMenu(key: const Key("123")),
            frontLayer: Column(
