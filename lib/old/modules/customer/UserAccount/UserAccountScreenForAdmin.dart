...
import 'package:food_order_app/old/modules/admin/adminBackLayerOpations/customerAccount/CustomerOrder.dart';
...
class UserAccountScreenForAdmin extends StatelessWidget {
  const UserAccountScreenForAdmin({required Key key}) : super(key: key);
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              onTap: () {
                                                navigateTo(context,
                                                    const CustomerOrdersScreen(key:   Key("95")));
                                              },
                                              child: Column(
                                                mainAxisAlignment:
                                                    MainAxisAlignment
