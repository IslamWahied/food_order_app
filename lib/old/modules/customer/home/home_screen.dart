    ...
    return BlocConsumer<HomeCubit, HomeState>(
      ...
      builder: (context, state) {
        ...
        return BackdropScaffold(
                  ...
                  ? Row(
                      children: [
                        GestureDetector(
                          onTap: () {
                            cubit.isShowBackLayer = false;
                            NavigatToAndReplace(context, const HomeLayout(key:Key("25")));
                        ...
                        IconButton(
                            onPressed: () {
                              cubit.isShowBackLayer = false;
                              NavigatToAndReplace(context, const HomeLayout(key:Key("26")));
          ...
          backLayer: UserBackLayerMenu(key: const Key("122")),
