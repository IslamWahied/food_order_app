...
class OrderDetailScreen extends StatelessWidget {
                      ...
                      if (additionsList.isNotEmpty)
                        Padding(
                          padding: const EdgeInsets.only(
                              left: 8.0, right: 25, bottom: 8, top: 8),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.end,
                            children: [
                              const Text('جنية',
                              ...
                              Text(
                                cubit.getTotalAddaitonlPriceForItem(
                                        index: index) ??
                                    '0',
                                style: TextStyle(
                                    fontWeight: FontWeight.w600,
            ...
            builder: (context) {
              return SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    cubit.listOrder
                        .removeWhere((item) => item == cubit.listOrder[index]);
  ...
  GestureDetector additionCard(
      {required String imagePath,required int additionId,required HomeCubit cubit,required context}) {
