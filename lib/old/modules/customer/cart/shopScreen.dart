...
class ShopScreen extends StatelessWidget {
  ...
  const ShopScreen({required this.isShowNavBar,required Key key}) : super(key: key);
    ...
    return BlocConsumer<HomeCubit, HomeState>(
        ...
        builder: (context, state) {
          ...
          return BackdropScaffold(
              ...
              backLayer: UserBackLayerMenu(key: const Key("124")),
        ...
        onTap: () {
          ...
          navigateTo(
              ...
              OrderDetailScreen(
                ...
                index: index,
                itemPrice: cubit.listOrder[index].price, key: const Key("22"),
              ));
        },
        child: Container(
          margin:
