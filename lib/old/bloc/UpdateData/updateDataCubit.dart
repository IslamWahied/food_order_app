        ...
        firebase_storage.FirebaseStorage.instance
          ...
          value.ref.getDownloadURL().then((value) {
            ...
            CategoryModel model = CategoryModel(
                ...
                categoryTitle:  txtUploadTitle.text, projectId: 0
            );
        ...
        firebase_storage.FirebaseStorage.instance
          ...
          value.ref.getDownloadURL().then((value) {
            ...
            SubCategory model = SubCategory(
                ...
                subCategoryTitle: txtUploadTitle.text, projectId: 0
            );
        ...
        firebase_storage.FirebaseStorage.instance
          ...
          value.ref.getDownloadURL().then((value) {
            ...
            ItemModel model = ItemModel(
                ...
                userName: Global.userName??'', isFavourite: false, orderState: '', projectId: 0
            );
            FirebaseFirestore.instance
                .collection('Items')
        ...
        firebase_storage.FirebaseStorage.instance.ref().child('Additions/${Uri.file(finalPickedProductImage.path).pathSegments.last}').putFile(finalPickedProductImage).then((value) {
          value.ref.getDownloadURL().then((value) {
            ...
            AdditionsModel model = AdditionsModel(
              ...
              orderCount: 0, isAvailable: false, projectId: 0,
